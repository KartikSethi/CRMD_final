...
public class BackgroundTask extends AsyncTask<String, Void, String> {
    ...
    //String imei="";
    String register_url =  "http://61.246.165.5/GPSAttendance/welcome/register";//"http://61.246.165.5/GPSAttendance/welcome/register";//  (name of the site) "http://192.168.X.X(ip of my comp or any other site)/directory name/php script
...
//                Log.v("IO","HEre");
    ...
    protected void onPostExecute(String json) {
        ...
        if (json == null) {
            network=false;
            String error_message = "No internet connection.";
...
//                        final int commit = activity.getFragmentManager().beginTransaction().replace(R.id.FragmentHolder, completedFragment).commit();
                    ...
                    progressDialog.dismiss();
                }else if (code.equals("report_failed")) {
                    String message = JO.getString("message"); // message as the key, getString will return the value from the key:value pair
                    showDialog("Submission error!", message, code);
                    progressDialog.dismiss();
                }
